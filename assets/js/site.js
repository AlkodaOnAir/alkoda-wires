const STRINGS = {
  en: {
    ...
    contact_youtube: "Tutorials, demos and Wires news",
  ...
  fr: {
    ...
    contact_discord: "Join the Wires Community",
    contact_youtube_label: "YouTube",
    contact_youtube: "Tutoriels, démonstrations et actualités Wires",
    contact_mail_label: "Mail",
  ...
  es: {
    ...
    contact_discord: "Join the Wires Community",
    contact_youtube_label: "YouTube",
    contact_youtube: "Tutoriales, demostraciones y novedades de Wires",
    contact_mail_label: "Mail",
