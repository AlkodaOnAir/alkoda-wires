const STRINGS = {
  en: {
    ...
    contact_youtube: "Tutorials and Wires news",
    ...
    downloads_version: "Version v1.2.0",
    ...
    downloads_release_notes: "See what’s new in version 1.2.0",
    release_kicker: "RELEASE NOTES",
    release_h1: "What’s new in Wires",
    release_intro: "Discover the new features and main fixes included in each version.",
    release_version_label: "LATEST VERSION",
    release_previous_version_label: "PREVIOUS VERSION",
    release_130_status: "Released August 24, 2026",
    release_130_new_01: "New full-screen view for positioning connection points more precisely.",
    release_130_new_02: "Optional numbering for a device's connection points.",
    release_130_new_03: "Enhanced Category/Cable/Zone filters: isolate or hide, with individual control per item.",
    release_130_new_04: "Each signal route can now be hidden independently of the others.",
    release_130_new_05: "Zones and text labels can now be copied and pasted.",
    release_130_new_06: "Each connector's type now displays while adding a cable.",
    release_130_new_07: "Interactive HTML export: Category/Cable/Zone filters are now complete, just like in the app.",
    release_130_fix_01: "Fixed the license purchase link blocking discount code entry.",
    release_120_status: "Released August 15, 2026",
    release_120_new_01: "Wires now automatically lets you know when a new version is available.",
    release_120_fix_01: "Security improvements.",
    release_status: "Released August 14, 2026",
    release_new_title: "What’s New",
    release_new_guide: "Interactive guide to get started with Wires from your very first project",
    release_export_title: "Export",
    release_new_01: "Wireless connections (WiFi, Bluetooth, HF) — document links with no physical cable",
    release_new_02: "A route can now have multiple signal types at once (e.g. Video + Audio)",
    release_new_03: "Right-click to copy/paste a route segment",
    release_new_04: "Automatic numbering for identical devices (same image = same model)",
    release_new_05: "Edit a device already placed on the canvas, no need to recreate it",
    release_new_06: "Drag and drop a route or path to reorganize it in one move",
    release_new_07: "Animate every route at once, or a single segment, with a double-click",
    release_new_08: "Pause animation playback with the space bar",
    release_new_09: "Optional cable length, included in the Pack List export",
    release_new_10: "HTML export: live preview of your project before exporting",
    release_new_11: "Pack List export: real generation, grouped by category or zone, with assignable people in charge",
    release_new_12: "Routes PDF export completely redesigned, with a route map",
    release_new_13: "Portrait/Landscape orientation for PDF exports",
    release_fixes_title: "Fixes",
    release_fix_01: "Deleting a device now actually deletes its cables too",
    release_fix_02: "Cables now route around neighboring devices more cleanly while dragging",
    release_fix_03: "Smoother route animation, no more stuttering",
    release_fix_04: "The minimap no longer shows full color for content outside the visible area",
    release_fix_05: "Several fixes in the export window (closing too early, icons, etc.)",
    release_download: "Go to downloads",
  ...
  fr: {
    ...
    footer_release_notes: "Notes de version",
    ...
    license_patch: "Liste de paquetage",
    ...
    contact_discord: "Join the Wires Community",
    contact_youtube_label: "YouTube",
    contact_youtube: "Tutoriels et actualités Wires",
    contact_mail_label: "Mail",
    ...
    downloads_release_notes: "Voir les nouveautés de la version 1.2.0",
    release_kicker: "NOTES DE VERSION",
    release_h1: "Les nouveautés de Wires",
    release_intro: "Découvrez les nouveautés et les principales corrections incluses dans chaque version.",
    release_version_label: "DERNIÈRE VERSION",
    release_previous_version_label: "VERSION PRÉCÉDENTE",
    release_130_status: "Publiée le 24 août 2026",
    release_130_new_01: "Nouvel écran plein format pour positionner les points de connexion plus précisément.",
    release_130_new_02: "Numérotation optionnelle des points de connexion d'un appareil.",
    release_130_new_03: "Filtres Catégories/Câbles/Zones enrichis : isoler ou masquer, avec un contrôle individuel par élément.",
    release_130_new_04: "Chaque route de signal peut désormais être masquée indépendamment des autres.",
    release_130_new_05: "Zones et étiquettes de texte copiables-collables.",
    release_130_new_06: "Le type de chaque connecteur s'affiche désormais pendant l'ajout d'un câble.",
    release_130_new_07: "Export HTML interactif : filtres Catégories/Câbles/Zones désormais complets, comme dans l'application.",
    release_130_fix_01: "Correction du lien d'achat de licence qui empêchait de saisir un code de réduction.",
    release_120_status: "Publiée le 15 août 2026",
    release_120_new_01: "Wires vous prévient désormais automatiquement quand une nouvelle version est disponible.",
    release_120_fix_01: "Renforcement de la sécurité.",
    release_status: "Publiée le 14 août 2026",
    release_new_title: "Nouveautés",
    release_new_guide: "Guide interactif pour prendre en main Wires dès le premier projet",
    release_export_title: "Export",
    release_new_01: "Connexions sans fil (WiFi, Bluetooth, HF) — documentez vos liaisons sans câble physique",
    release_new_02: "Une route peut avoir plusieurs types de signal à la fois (ex. Vidéo + Audio)",
    release_new_03: "Copier/coller un segment de route par clic droit",
    release_new_04: "Numérotation automatique des appareils identiques (même image = même modèle)",
    release_new_05: "Modifier un appareil déjà posé, sans avoir à le recréer",
    release_new_06: "Glisser-déposer une route ou un chemin pour le réorganiser en un clic",
    release_new_07: "Animer toutes les routes d'un coup, ou un segment isolé, en double-clic",
    release_new_08: "Pause de l'animation avec la barre d'espace",
    release_new_09: "Longueur de câble optionnelle, reprise dans l'export Liste de Paquetage",
    release_new_10: "Export HTML : aperçu en direct de votre projet avant export",
    release_new_11: "Export Liste de Paquetage : génération réelle, regroupée par catégorie ou par zone, responsables assignables",
    release_new_12: "Export Routes en PDF entièrement repensé, avec plan de la route",
    release_new_13: "Orientation Portrait/Paysage pour les exports PDF",
    release_fixes_title: "Corrections",
    release_fix_01: "Supprimer un appareil supprime maintenant réellement ses câbles",
    release_fix_02: "Câbles qui contournent mieux les appareils voisins pendant un déplacement",
    release_fix_03: "Animation des routes plus fluide, sans saccades",
    release_fix_04: "La minimap n'affiche plus en couleur ce qui est hors champ",
    release_fix_05: "Plusieurs correctifs dans la fenêtre d'export (fermeture prématurée, icônes, etc.)",
    release_download: "Accéder aux téléchargements",
  ...
  es: {
    ...
    footer_release_notes: "Notas de versión",
    ...
    license_patch: "Lista de material",
    ...
    contact_discord: "Join the Wires Community",
    contact_youtube_label: "YouTube",
    contact_youtube: "Tutoriales y novedades de Wires",
    contact_mail_label: "Mail",
    ...
    downloads_release_notes: "Ver las novedades de la versión 1.2.0",
    release_kicker: "NOTAS DE VERSIÓN",
    release_h1: "Novedades de Wires",
    release_intro: "Descubre las novedades y las principales correcciones incluidas en cada versión.",
    release_version_label: "ÚLTIMA VERSIÓN",
    release_previous_version_label: "VERSIÓN ANTERIOR",
    release_130_status: "Publicada el 24 de agosto de 2026",
    release_130_new_01: "Nueva pantalla a pantalla completa para posicionar los puntos de conexión con más precisión.",
    release_130_new_02: "Numeración opcional para los puntos de conexión de un aparato.",
    release_130_new_03: "Filtros de Categorías/Cables/Zonas mejorados: aislar u ocultar, con control individual por elemento.",
    release_130_new_04: "Cada ruta de señal ahora puede ocultarse de forma independiente de las demás.",
    release_130_new_05: "Las zonas y las etiquetas de texto ahora se pueden copiar y pegar.",
    release_130_new_06: "El tipo de cada conector ahora se muestra al añadir un cable.",
    release_130_new_07: "Exportación HTML interactiva: los filtros de Categorías/Cables/Zonas ahora están completos, igual que en la aplicación.",
    release_130_fix_01: "Corregido el enlace de compra de licencia que impedía introducir un código de descuento.",
    release_120_status: "Publicada el 15 de agosto de 2026",
    release_120_new_01: "Wires ahora te avisa automáticamente cuando hay una nueva versión disponible.",
    release_120_fix_01: "Mejoras de seguridad.",
    release_status: "Publicada el 14 de agosto de 2026",
    release_new_title: "Novedades",
    release_new_guide: "Guía interactiva para aprender a usar Wires desde el primer proyecto",
    release_export_title: "Exportación",
    release_new_01: "Conexiones inalámbricas (WiFi, Bluetooth, HF) — documenta enlaces sin cable físico",
    release_new_02: "Una ruta puede tener ahora varios tipos de señal a la vez (ej. Vídeo + Audio)",
    release_new_03: "Copiar/pegar un segmento de ruta con clic derecho",
    release_new_04: "Numeración automática de dispositivos idénticos (misma imagen = mismo modelo)",
    release_new_05: "Modificar un dispositivo ya colocado, sin necesidad de recrearlo",
    release_new_06: "Arrastra y suelta una ruta o camino para reorganizarlo en un solo gesto",
    release_new_07: "Anima todas las rutas a la vez, o un solo segmento, con doble clic",
    release_new_08: "Pausa la animación con la barra espaciadora",
    release_new_09: "Longitud de cable opcional, incluida en la exportación de Lista de Material",
    release_new_10: "Exportación HTML: vista previa en directo de tu proyecto antes de exportar",
    release_new_11: "Exportación Lista de Material: generación real, agrupada por categoría o zona, con responsables asignables",
    release_new_12: "Exportación de Rutas en PDF totalmente rediseñada, con plano de la ruta",
    release_new_13: "Orientación Vertical/Horizontal para las exportaciones en PDF",
    release_fixes_title: "Correcciones",
    release_fix_01: "Eliminar un dispositivo ahora elimina también sus cables de verdad",
    release_fix_02: "Los cables rodean mejor a los dispositivos vecinos al arrastrar",
    release_fix_03: "Animación de rutas más fluida, sin tirones",
    release_fix_04: "El minimapa ya no muestra en color lo que queda fuera de la vista",
    release_fix_05: "Varias correcciones en la ventana de exportación (cierre prematuro, iconos, etc.)",
    release_download: "Ir a las descargas",
