const STRINGS = {
  en: {
    ...
    home_problem_kicker: "The practical problem",
    home_problem_h2: "Your cabling becomes unreadable when the setup grows.",
    home_problem_text: "Cameras, switchers, displays, converters, computers and networks multiply quickly. Wires brings order back with real device images, precise ports, animated signal paths and documentation your team can reuse.",
    value_real_title: "Real equipment",
    value_real_text: "Use actual pictures of your devices and place ports where they physically exist.",
    value_routes_title: "Animated signal",
    value_routes_text: "Follow the signal across a complete path, including multiple cable segments.",
    value_offline_title: "Offline desktop app",
    value_offline_text: "Work locally on Windows or macOS, even in a venue with unreliable internet.",
    value_custom_title: "Highly configurable",
    value_custom_text: "Create your own cable types, colors, zones, devices, labels and routing logic.",
    ...
    export_kicker: "Export and share",
    export_h2: "Turn your plan into usable documentation.",
    export_text: "Share an interactive HTML viewer, produce a PDF for the field, or export a connection list for the crew.",
    export_html_title: "Interactive viewer",
    export_html_text: "Open the exported plan in a browser and inspect devices, cables and routes.",
    export_pdf_title: "Field document",
    export_pdf_text: "Print or archive a readable view of the technical installation.",
    export_patch_label: "List",
    export_patch_title: "Connection list",
    export_patch_text: "Keep the cable list close when preparing, checking or rebuilding a setup.",
    ...
    features_page_sub: "Wires is built around the parts that matter in the real world: recognizable equipment, physical ports, readable cabling and complete signal paths.",
    ...
    features_grid_h2: "Precise enough for technicians. Clear enough for the whole team.",
    ...
    use_cases_h2: "Built for real rooms, real people and real pressure.",
    use_cases_text: "These blocks are ready for the AI images you want to provide later. Each one can show a different kind of team using Wires in context.",
  ...
  fr: {
    ...
    home_problem_kicker: "Le problème concret",
    home_problem_h2: "Votre câblage devient vite illisible quand l'installation grandit.",
    home_problem_text: "Caméras, mélangeurs, écrans, convertisseurs, ordinateurs et réseaux se multiplient rapidement. Wires remet de l'ordre avec des images réelles d'appareils, des ports précis, des chemins de signal animés et une documentation réutilisable par l'équipe.",
    value_real_title: "Appareils réels",
    value_real_text: "Utilisez les vraies images de vos appareils et placez les ports exactement où ils existent.",
    value_routes_title: "Signal animé",
    value_routes_text: "Suivez le signal sur un chemin complet, même à travers plusieurs segments de câble.",
    value_offline_title: "Application desktop offline",
    value_offline_text: "Travaillez localement sur Windows ou macOS, même dans une salle avec un internet instable.",
    value_custom_title: "Très paramétrable",
    value_custom_text: "Créez vos types de câbles, couleurs, zones, appareils, étiquettes et logiques de route.",
    ...
    export_kicker: "Exporter et partager",
    export_h2: "Transformez votre plan en documentation utilisable.",
    export_text: "Partagez une visionneuse HTML interactive, produisez un PDF de terrain ou exportez une liste de connexions pour l'équipe.",
    export_html_title: "Visionneuse interactive",
    export_html_text: "Ouvrez le plan exporté dans un navigateur et inspectez appareils, câbles et routes.",
    export_pdf_title: "Document terrain",
    export_pdf_text: "Imprimez ou archivez une vue lisible de l'installation technique.",
    export_patch_label: "Liste",
    export_patch_title: "Liste de connexions",
    export_patch_text: "Gardez la liste des câbles sous la main pour préparer, vérifier ou reconstruire un setup.",
    ...
    features_page_sub: "Wires part de ce qui compte dans le monde réel : appareils reconnaissables, ports physiques, câblage lisible et chemins de signal complets.",
    ...
    features_grid_h2: "Assez précis pour les techniciens. Assez clair pour toute l'équipe.",
    ...
    use_cases_h2: "Pensé pour de vraies salles, de vraies équipes et la pression du terrain.",
    use_cases_text: "Ces blocs sont prêts pour les images générées par IA que tu voudras fournir plus tard. Chaque visuel pourra montrer un contexte d'utilisation différent.",
  ...
  es: {
    ...
    home_problem_kicker: "El problema practico",
    home_problem_h2: "Tu cableado se vuelve ilegible cuando la instalacion crece.",
    home_problem_text: "Camaras, mezcladores, pantallas, convertidores, ordenadores y redes se multiplican rapidamente. Wires devuelve el orden con imagenes reales de dispositivos, puertos precisos, rutas de senal animadas y documentacion reutilizable por el equipo.",
    value_real_title: "Equipos reales",
    value_real_text: "Usa imagenes reales de tus dispositivos y coloca los puertos donde existen fisicamente.",
    value_routes_title: "Senal animada",
    value_routes_text: "Sigue la senal en un camino completo, incluso a traves de varios segmentos de cable.",
    value_offline_title: "Aplicacion desktop offline",
    value_offline_text: "Trabaja localmente en Windows o macOS, incluso en un venue con internet inestable.",
    value_custom_title: "Muy configurable",
    value_custom_text: "Crea tus tipos de cables, colores, zonas, dispositivos, etiquetas y logica de rutas.",
    ...
    export_kicker: "Exportar y compartir",
    export_h2: "Convierte tu plano en documentacion util.",
    export_text: "Comparte un visor HTML interactivo, produce un PDF de campo o exporta una lista de conexiones para el equipo.",
    export_html_title: "Visor interactivo",
    export_html_text: "Abre el plano exportado en un navegador e inspecciona dispositivos, cables y rutas.",
    export_pdf_title: "Documento de campo",
    export_pdf_text: "Imprime o archiva una vista legible de la instalacion tecnica.",
    export_patch_label: "Lista",
    export_patch_title: "Lista de conexiones",
    export_patch_text: "Ten la lista de cables cerca al preparar, verificar o reconstruir un setup.",
    ...
    features_page_sub: "Wires parte de lo que importa en el mundo real: equipos reconocibles, puertos fisicos, cableado legible y caminos completos de senal.",
    ...
    features_grid_h2: "Preciso para tecnicos. Claro para todo el equipo.",
    ...
    use_cases_h2: "Pensado para salas reales, equipos reales y presion real.",
    use_cases_text: "Estos bloques quedan listos para las imagenes generadas por IA que quieras aportar mas adelante. Cada visual podra mostrar un contexto de uso diferente.",
